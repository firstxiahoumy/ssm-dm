        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdownb ">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="${pageContext.request.contextPath}/install" name="dTag" aria-valuetext="${dTag}" aria-placeholder="install">install</a>
                    </li>
                    <li class="divider">
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/compress" name="dTag" aria-valuetext="${dTag}" aria-placeholder="compress">compress</a>
                    </li>
                    <li class="divider">
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/media" name="dTag" aria-valuetext="${dTag}" aria-placeholder="media">media</a>
                    </li>
                    <li class="divider">
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/directory" name="dTag" aria-valuetext="${dTagkk,,,}" aria-placeholder="directory">directory</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/update" name="uEmail" aria-valuetext="${uEmail}" aria-placeholder="get.session()">oneself</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/logout" aria-valuetext="${uEmail}" aria-placeholder="get.session()">logout</a>
                    </li>
                    <li>
