            ...
            <div class="row clearfix">
                <div class="col-md-5 column">
                    ...
                    <form action="${pageContext.request.contextPath}/forgot" role="form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="uPwd" value="${uPwd}" id="exampleInputPassword1" style="background-color: #aaa999; color: #000000;" required data-eye />

                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword2">new Password:</label>
                            <input type="password" class="form-control" name="uPwd" value="${uPwd}" id="exampleInputPassword2" onkeyup="checkPassword()" style="background-color: #aaa999; color: #000000;" required data-eye />
                            <span id="hint"></span>
                ...
                <div class="col-md-7 column">
                    <div id="" style="margin-top: 110px;">
                        <img alt="back img" src="${pageContext.request.contextPath}/img/user-login-back.jpg" width="100%" />
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function checkPassword() {
        ...
        var chkPassword = document.getElementById("exampleInputPassword2").value;
