...
<head>
    ...
    <!--  -->
    <title>blogEditor || Directory Management</title>
    <!-- jquery -->
...
<div class="container">
    ...
    <div class="row" style="text-align: center">
        <div class="col-md-3">
            <a href="${pageContext.request.contextPath}/article/toUploadBlog">
        ...
        <div class="col-md-3">
            <a href="${pageContext.request.contextPath}/article/toDraftBlog">
