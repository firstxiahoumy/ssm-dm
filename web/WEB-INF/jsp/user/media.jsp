...
<head>
    ...
    <!--  -->
    <title>media || Directory Management</title>
    <!-- jquery -->
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                <e:forEach var="media" items="${requestScope.get('media')}">
                    <tr>
                        <td>${media.dId}</td>
                        <td>${media.iEmail}</td>
                        <td>${media.dLink}</td>
                        ...
                        <td>${media.iTime}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/toUpdateRecord/${media.dId}">修改</a>
                            &nbsp;|&nbsp;
                            <a href="${pageContext.request.contextPath}/del/${media.dId}">删除</a>
                        </td>
                    </tr>
                </e:forEach>
                </tbody>
