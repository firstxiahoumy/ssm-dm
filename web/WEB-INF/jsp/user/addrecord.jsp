...
<head>
    ...
    <!--  -->
    <title>addRecord || Directory Management</title>
    <!-- jquery -->
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/addRecord" method="post">
        <div class="form-group">
            <label>邮箱:</label>
            <input type="email" name="iEmail" class="form-control" value="${user.uEmail}" required readonly>
        </div>
        <div class="form-group">
            <label>链接:</label>
            <input type="url" name="dLink" class="form-control" required>
        </div>
        <div class="form-group">
            <label>标签:</label>
            <input type="text" name="dTag" class="form-control" required>
        </div>
        <div class="form-group">
            <label>注释:</label>
            <input type="text" name="dAnn" class="form-control" required>
        </div>
        <div class="form-group">
            <label>回馈:</label>
            <input type="tel" name="iTel" class="form-control" required>
        </div>
        <%--        <div class="form-group">--%>
        <%--            <label>时间:</label>--%>
        <%--            <input type="date" name="iTime" class="form-control" required>--%>
        <%--        </div>--%>
        <div class="form-group">
            <input type="submit" value="添加" class="form-control btn btn-primary btn-default">
        </div>
    </form>
