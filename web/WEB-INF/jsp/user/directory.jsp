...
<head>
    ...
    <!--  -->
    <title>dircetory || Directory Management</title>
    <!-- jquery -->
    ...
    <div class="row">
        <div class="col-md-12">
            <table  class="table table-hover table-striped">
                ...
                <tbody>
                <e:forEach var="directory" items="${requestScope.get('directory')}">
                    <tr>
                        <td>${directory.dId}</td>
                        <td>${directory.iEmail}</td>
                        <td>${directory.dLink}</td>
                        <td>${directory.dTag}</td>
                        <td>${directory.dAnn}</td>
                        <td>${directory.iTel}</td>
                        <td>${directory.iTime}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/toUpdateRecord/${directory.dId}">修改</a>
                            &nbsp;|&nbsp;
                            <a href="${pageContext.request.contextPath}/del/${directory.dId}">删除</a>
                        </td>
                    </tr>
                </e:forEach>
                </tbody>
