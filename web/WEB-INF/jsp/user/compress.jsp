...
<head>
    ...
    <!--  -->
    <title>compress || Directory Management</title>
    <!-- jquery -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdownb active">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">cintentList<strong class="caret"></strong></a>
    ...
    <div class="row">
        <div class="col-md-12">
            <table  class="table table-hover table-striped">
                ...
                <tbody>
                <e:forEach var="compress" items="${requestScope.get('compress')}">
                    <tr>
                        <td>${compress.dId}</td>
                        <td>${compress.iEmail}</td>
                        <td>${compress.dLink}</td>
                        <td>${compress.dTag}</td>
                        <td>${compress.dAnn}</td>
                        <td>${compress.iTel}</td>
                        <td>${compress.iTime}</td>
<%--                        <td><fmt:formatDate value="${compress.iTime}" type="both"/></td>--%>
                        <td>
                            <a href="${pageContext.request.contextPath}/toUpdateRecord/${compress.dId}">修改</a>
                            &nbsp;|&nbsp;
                            <a href="${pageContext.request.contextPath}/del/${compress.dId}">删除</a>
                        </td>
                    </tr>
                </e:forEach>
                </tbody>
