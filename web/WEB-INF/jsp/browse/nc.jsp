...
<head>
    ...
    <!--  -->
    <title>nc || Directory Management</title>
    <!-- 引入 bootstrap css文件 -->
<%--    <link rel="stylesheet" href="../../dm_net/bootstrap/dist/css/bootstrap.min.css" type="text/css">--%>
    <!-- 引入 bootstrap js文件 -->
<%--    <script href="../../dm_net/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>--%>
    <!-- 自己定义css -->
...
<body>
<%--<div><h1>Read About Directory Management Information With ningci.com</h1></div>--%>
<!-- nav -->
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li class="dropdown">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/browse/nc">nc</a></li>
