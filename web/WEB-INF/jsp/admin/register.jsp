            ...
            <div class="row clearfix">
                <div class="col-md-3 column">
                    <div style="margin: 22px 15px 0 0;">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/toLogin" style="color: #111111;">
                ...
                <div class="col-md-6 column">
                    <h2 style="margin-bottom: 40px; text-align: center;"><span>注册账号</span></h2>
                    <form action="${pageContext.request.contextPath}/admin/register" class="form-horizontal" role="form"
                          method="post">
...
<script type="text/javascript">
    <%--$(function () {--%>
    <%--    $(":input[name='eamil']").change(function () {--%>
    <%--        var val = $(this.val());--%>
    <%--        var =--%>
    <%--        $.trim(val);--%>
    ...
    $(document).ready(function () {
        $("#email").blur(function () {
            $.post("${pageContext.request.contextPath}/checkEmail",{email:$(this).val()},function (data) {
                if (data == "true"){
                    $(#message).html("用户已存在");
                }else {
                    $("#message").html("用户名可用");
