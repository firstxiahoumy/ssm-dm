        ...
        <div class="col-md-12 column">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-6 column">
                    <h2 style="margin-bottom: 40px; text-align: center;"><span>找回密码</span></h2>
                    <form action="${pageContext.request.contextPath}/admin/forgot" class="form-horizontal" role="form"
                          method="post">
                        <div class="form-group">
                            <label for="inputEmail" class="col-sm-2 control-label">Email:</label>
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputEmail" name="email" value="${eamil}"
