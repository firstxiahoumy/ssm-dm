...
<%--    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/ionicons.min.css">--%>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/adminlte.min.css">
...
<!-- DM Web App -->
<script src="${pageContext.request.contextPath}/js/admin/adminlte.js" type="text/javascript"></script>
