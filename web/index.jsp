...
<head>
    ...
    <!-- 自定义css -->
    <link rel="stylesheet" href="css/bower/first_page.css" type="text/css">
    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover">
                ...
                <p class="lead">
                    <a href="${pageContext.request.contextPath}/browse/read" class="btn btn-lg btn-default">Learn more</a>
                </p>
            </div>
